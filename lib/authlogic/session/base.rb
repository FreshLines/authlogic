...
module Authlogic
  module Session
    ...
    class Base
      ...
      before_persisting :reset_stale_state, :unless => (:single_access? || :persist_by_http_auth?)
      ...
      after_persisting :enforce_timeout, :unless => (:single_access? || :persist_by_http_auth?)
